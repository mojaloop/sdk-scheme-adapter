...
export type IBulkTransactionEntityRepo = {
    ...
    incrementBulkTransfersSuccessCount: (bulkId: string, increment: number) => Promise<number>
    incrementBulkTransfersFailedCount: (bulkId: string, increment: number) => Promise<number>
    ...
    incrementBulkQuotesSuccessCount: (bulkId: string, increment: number) => Promise<number>
    getBulkQuotesFailedCount: (bulkId: string) => Promise<number>
    setBulkQuotesFailedCount: (bulkId: string, count: number) => Promise<void>
    incrementBulkQuotesFailedCount: (bulkId: string, increment: number) => Promise<number>
