...
export class SDKOutboundBulkAcceptQuoteRequestedMessage extends DomainEventMessage {
    ...
    static CreateFromDomainEventMessage(message: DomainEventMessage): SDKOutboundBulkAcceptQuoteRequestedMessage {
