...
// ######### NOTE ##############################################
// The following are the types prepared initially for reference
// Please move these types to appropriate location
// Please do not import the types from this file
