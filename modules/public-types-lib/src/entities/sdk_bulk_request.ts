...
let someVar1: SDKSchemeAdapter.OutboundTypes.Currency // TODO: We can import types like this if we maintain the types in api snippets library.
type Currency = SDKSchemeAdapter.OutboundOpenAPI.components['schemas']['Money'] // TODO: This is another option. We can get the required property from api-snippets like this and create types for them in individual projects.
let someVar2: Currency
// TODO: We need to export JSON Schema of individual parts for schema validation from api-snippets library. The types are not sufficient for schema validation including regular expressions.
