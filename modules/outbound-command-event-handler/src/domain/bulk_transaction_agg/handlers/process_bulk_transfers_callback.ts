...
export async function handleProcessBulkTransfersCallbackCmdEvt(
    ...
    try {
        ...
        let bulkTransfersSuccessCountAfterIncrement;
        let bulkTransfersFailedCountAfterIncrement;
        ...
        const bulkTransfersSuccessCount = bulkTransfersSuccessCountAfterIncrement || await bulkTransactionAgg.getBulkTransfersSuccessCount();
        const bulkTransfersFailedCount = bulkTransfersFailedCountAfterIncrement || await bulkTransactionAgg.getBulkTransfersFailedCount();
