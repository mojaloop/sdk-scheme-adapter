...
describe.skip('SDKOutboundBulkRequestReceivedDmEvt', () => {
  ...
  test('should publish a domain event', async () => {
    ...
    const sampleSDKOutboundBulkRequestReceivedDmEvtData: ISDKOutboundBulkRequestReceivedDmEvtData = {
      bulkRequest: bulkRequest,
      timestamp: Date.now(),
      headers: []
    }
    const domainEventObj = new SDKOutboundBulkRequestReceivedDmEvt(sampleSDKOutboundBulkRequestReceivedDmEvtData);
