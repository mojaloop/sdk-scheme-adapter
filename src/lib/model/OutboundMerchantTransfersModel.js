...
const merchantTransferStateEnum = {
 ...
 */
class OutboundMerchantTransfersModel {
    constructor(config) {
    ...
    /**
     * Initializes the merchantTransfer model
     *
     * @param data {object} - The inbound API POST /merchantTransfers request body
     */
    ...
    getResponse() {
        ...
        switch(this.data.currentState) {
            ...
            case 'errored':
                resp.currentState = merchantTransferStateEnum.ERROR_OCCURRED;
                break;
...
module.exports = OutboundMerchantTransfersModel;
