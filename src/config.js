...
module.exports = {
    ...
    notificationRetryCount: env.get('NOTIFICATION_RETRY_COUNT').default(0).asIntPositive(),
    notifciationRetryDelayMs: env.get('NOTIFICATION_RETRY_DELAY_MS').default(3000).asIntPositive()
};
